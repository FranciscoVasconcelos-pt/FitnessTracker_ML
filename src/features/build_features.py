...
df_temporal = pd.concat(df_temporal_list)  # para cada set adicionamos a mean e o std
# --------------------------------------------------------------
# Frequency features
# --------------------------------------------------------------
...
df_freq = df_freq.iloc[
    ::2
]  # quero todas as colunas de dois em dois, ou seja, corto o df em dois
...
for k in k_values:
    ...
    inertias.append(kmeans.inertia_)  # inertia é a distancia ao centro do cluster
